          ...
          <S.Box>
            ...
            <S.NavigationMenu>
              ...
              <S.Menu>
                <ScrollTo>
                  {({ scroll }) => (
                    <S.MenuButton onClick={() => scroll({ x: 0, y: 1000 })}>Products</S.MenuButton>
                  )}
                </ScrollTo>
                <ScrollTo>
                  {({ scroll }) => (
                    <S.MenuButton onClick={() => scroll({ x: 0, y: 2100 })}>App</S.MenuButton>
                  )}
                </ScrollTo>
                <ScrollTo>
                  {({ scroll }) => (
                    <S.MenuButton onClick={() => scroll({ x: 0, y: 500 })}>Benefit</S.MenuButton>
                  )}
                </ScrollTo>
                <ScrollTo>
                  {({ scroll }) => (
                    <S.MenuButton onClick={() => scroll({ x: 0, y: 500 })}>About Us</S.MenuButton>
                  )}
                </ScrollTo>
              </S.Menu>
